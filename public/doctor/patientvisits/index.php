    ...
    <?php
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST"):
                            ...
                            if ($result == false)
                            {
                                ...
                                $error .= '<strong>Error occured! </strong>Latest edit of medical record has not been saved, please try again.';
    ...
    <div class="container mt-5">
        ...
        <div class="col-auto">
            <img src="<?php echo $facility_icons[$valid_vars->get_facility()->get_facilityid()]; ?>"
                alt="<No Image Available>" onerror="this.onerror=null;this.src='../img/example_img.jpg';"
