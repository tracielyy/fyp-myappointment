	...
	<script type="text/javascript" src="../js/medjs.js"></script>
		<div>
			<section id="what-is-it-for">
				<h1><b>Hydrochlorothiazide</b></h1>
				<h3>Hydrochlorothiazide - What is it for</h3>
				<p> Hydrochlorothiazide belongs to a class of medications called Diuretics. It works on your kidneys to get rid of extra water and salts in your body. </p>
			...
			<section id="side-effect">
				...
				<p>To make sure hydrochlorothiazide is safe for you, tell your doctor if you have ever had:</p>
				<ul>
					<li>Kidney disease</li>
					<li>Gout</li>
					<li>Low levels of potassium or sodium in your blood</li>
					<li>Diabetes</li>
					<li>Parathyroid gland disorder</li>
				</ul>
				
				<h5> What side effects can Hydrochlorothiazide cause? </h5>
				<ul>
					...
					<li> More sensitive to sunlight, skin rash </li>
					<ul>
						<li> Avoid unnecessary sunlight exposure. Use sunblock, sunglasses or wear covered clothes to protect your skin and eyes from excessive sunlight exposure. </li>
					</ul>
				</ul>
				<p> Inform your healthcare professional if these side effects do not go away and become bothersome to you. </p>
				<p> Very rarely, this medication may be linked to the increased risk of Non-melanoma skin cancer. Overseas studies involving Caucasians (fair skin) have shown that taking higher doses of this medication for long periods of time is linked to a very small risk of this skin cancer. The results of these studies cannot be directly applied to most of the Singaporean population as the skin types are very different. The risk of this skin cancer caused by this medication is likely to be lower in the local population </p>
				<ul>
					<li> Inform your doctor immediately if you notice any new, abnormal skin lesions or unusual lumps or patches on your skin that do not heal or go away after a few weeks. </li>
					<li> Avoid standing under midday sun (11am to 4pm) and seek shade whenever possible </li>
					<li> Take extra care by wearing long-sleeved clothes and applying sunblock to protect yourself from the sun. </li>
				</ul>
