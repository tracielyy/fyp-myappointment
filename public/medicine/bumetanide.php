	...
	<script type="text/javascript" src="../js/medjs.js"></script>
		<div>
			<section id="what-is-it-for">
				<h1><b>Bumetanide</b></h1>
				<h3>Bumetanide - What is it for</h3>
				<p>​Bumetanide belongs to a class of medications called Diuretics. It works on your kidneys to get rid of extra water and salts in your body.</p>
			...
			<section id="side-effect">
				...
				<h5> Warnings </h5>
				<p>You should not use bumetanide if you are unable to urinate, if you have severe kidney or liver disease, if you are severely dehydrated, or if you have an electrolyte imbalance (low potassium or magnesium). </p>
				
				<h5>Before taking this medicine</h5>
				<p> You should not use bumetanide if you are allergic to it, or if you have:</p>
				<ul>
					<li>Severe kidney disease or are unable to urinate</li>
					<li>Severe liver disease or cirrhosis</li>
					<li>Severe dehydration</li>
					<li>Electrolyte imbalance </li>
				</ul>
				<h5> What side effects can Bumetanide cause? </h5>
				<ul>
			...
			<section id="storage">
				...
				<ul>
					...
					<li> ​Throw away all expired medication </li>
				</ul>
			</section>
		</div>
