...
<head>
	<!-- Title -->
	<title>Conditions & Treatments</title>
...
<script type="text/javascript" src="js/alphaListNav.js"></script>
			...
			<div class="my-5 col-sm-12">
				<div class="w-auto shadow card p-3 col-xs-12 col-lg-9">
					<div class="card-body m-1">
						...
						<div class="px-1">
							<div class="main">
								<h5> <br>Find information on specific medical conditions and treatments.  </h5>
								<!--<input id="searchbar" onkeyup="search_function()" type="text" name="search" placeholder="Search by name of medicine">-->
								<input type="search" id="searchbar" onkeyup="search_function()" placeholder="Search for a condition">
								<div class="container">
								<h6>Search alphabetically </h6>
									<div id="btnlist">
										...
										<?php
										if($directory = opendir('conditiontreatment/')){
											while (false !== ($conditiontreatment = readdir($directory))){
												$displayName = str_replace("_", " ", $conditiontreatment);
												if($conditiontreatment  != "." && $conditiontreatment  != ".."){
													echo "<li class=\"btn\"><a href=\"/conditiontreatment/".$conditiontreatment."\">".ucwords(basename($displayName ,".php").PHP_EOL, " ")."</a></li>";
												}
											}
										}
										?>								
	...
	<script>
		...
		const listElem = document.getElementById('conditionlist');
