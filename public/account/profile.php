            ...
            <div id="account" class="tab-pane shadow rounded active">
                <div class="container chart-container mt-3">
                    ...
                    <div class="text-muted  mt-0">New email needs to be verified first, before the new email gets
                        updated.</div>
                    <form id="changeEmail" class="form-group mt-1" action="">
                        <div class="row">
                            <div id="inputgroupemail" class="input-group w-75">
                                ...
                                <button type="button" class="btn btn-outline-secondary" type="button" id="verifybutton"
                        ...
                        <div class="row">
                            <div class="col-auto">
                                <button id="chgEmailBttn" type="submit" class="btn btn-primary mt-2"
            ...
            success: function(valid_otp) {
                ...
                if (valid_status === 'true') {
                    ...
                    if (!$("#otp-feedback").length) {
                        var otp_feedback =
                            "<div id='otp-feedback' class='invalid-feedback'>Incorrect OTP Entered</div>";
