...
if ($_SERVER["REQUEST_METHOD"] == "POST") :
    ...
    endif; # -- END CHANGE EMAIL TRIGGER
    ...
    endif; # -- END CHANGE PASSWORD TRIGGER


    if (isset($_POST["btn_change_others"])) :

    endif; # -- END CHANGE CONTACT & ADDRESS
    ...
    foreach ($_POST as $key => $value) {
        if (isset($profile_arr[$key])) {
            $profile_arr[$key] = htmlspecialchars($value);
                                    ...
                                    <div class="col-sm-8 bg-white rounded-end shadow">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input name="email" class="form-control" type="text" value="<?php echo $user->get_email(); ?>">
                                            </div>
                                            <!-- PHONE  (CONTACT NUMBER) -->
                                            <div class="col-sm-6">
                                                <p class="font-weight-bold">Phone:</p>
                                                <input name="contactnumber" class="form-control" type="text" value="<?php echo $user->get_contactnumber(); ?>">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input name="address" class="form-control" type="text" value="<?php echo $user->get_address(); ?>"/>
                                            </div>
                                            <div class="col-sm-6">
