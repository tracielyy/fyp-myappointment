        ...
        <div class="row">
            <div class="row row-cols-1 row-cols-md-3 gx-4">
               ...
               for($i = 0; $i < $index; $i++)
               {
                ...
                echo '<a href="healthtips/article.php?id='.$all_health_articles[$i]->get_id().'" class="card-link stretched-link"><small class="text-muted">Click here to read more...</small></a>'; //NEED TO CHANGE TO REAL URL
