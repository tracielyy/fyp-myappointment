        ...
        <div class="container">
            <div class="row mt-3">
                <div class="d-grid gap-2 col-6 mx-auto">
                    <a type="button" class="btn btn-info btn-lg pb-2" href="./createappointment.php">
                                    ...
                                    <div class="col">
                                        <div class="card shadow" style="border-radius: 10px;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <br>
                                                <br>Date:
                                                <?php echo Time::date_format_change($record->get_scheduledon()->get_date(), Time::DATE_FORMAT_APPOINTMENT); // Returns Date                                                          ?>
                                                <br>Time:
                                                <?php echo Time::to_12hours($record->get_scheduledon()->get_time(), false); // Returns Time                                                          ?>
                                                <br>Location:
                                                <?php echo $record->get_facility()->get_facilityname(); // Returns Date                                                          ?>
                                                ...
                                                <div class="row m-2 text-center">
                                                    ...
                                                    ?>
                                                    <div class="col">
                                                        <button value="<?php echo $appt_info; ?>" type="button"
                                                                class="btn btn-danger col-12" data-bs-toggle="modal"
                                                                data-bs-target="#cancelappt"
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal hide fade" id="cancelappt" tabindex="-1"
                                                         aria-labelledby="cancelappointment" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="cancelappointment">Cancellation
                                                                        Confirmation</h5>
                                                                ...
                                                                <div class="modal-body" id="upcoming_cancel_modal_body">
                                                                    You are about to cancel your appointment of <br><span
                                                                        id="upcoming_cancel_appt_type"></span> on
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button id="upcoming_cancel_btn" type="submit"
                                                                            class="btn btn-danger" name="cancel">Cancel</button>
                                                                </div>
