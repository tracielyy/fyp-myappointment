                        ...
                        <div class="col-lg-12">
                            <div class="card ms-auto me-auto outerCard" style="max-width: 55rem;">
                                <div class="card-body">
                                    ...
                                    <!-- FAQ Body -->
                                    <div class="card text-dark innerCard mb-3" id="new-faq">
                                        <!-- FORM -->
                                        <form id="add_faq_form" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                                            <div class="card-title ms-2 mt-2">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10"  id="question-container">
                                                        <input type="text" class="form-control" id="question" style="max-width:90%" name="question" placeholder="Enter question here" value="<?php echo $faq_info['question']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10"  id="answer-container">
                                                        <textarea name="answer" class="form-control" id="answer" cols="30" rows="8" name="answer" placeholder="Enter answer here"><?php echo $faq_info['answer']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="d-grid gap-2 d-md-flex justify-content-md-end" style=" margin-top: 10px;">
                                                    <button type="submit" class="btn btn-dark me-md-2 mr-2" name="add_faq">
                    ...
                    if (isset($_POST['add_faq'])):
                        ...
                        if (in_array(FALSE, $validArr)) :
                            ...
                            <script>
                                ...
                                var spinner = '<div class="spinner-border m-5" role="status" style="width: 20rem; height: 20rem; border-width:3em;"></div>';
                                $('#new-faq').append(spinner_container);
                                $('#spinner-container').append(spinner);
                            </script>
                            <?php
                            # Add To Database
                            Faq::create_faq($faq_info);
