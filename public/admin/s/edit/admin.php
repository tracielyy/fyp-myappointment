                    ...
                    <div class="card text-dark innerCard mb-3">
                        <div class="card-title ms-2 mt-2">
                            ...
                            <div class="d-grid gap-1 d-md-flex justify-content-md-start" style=" margin-top: 10px;">
                              <input type="text" readonly class="form-control-plaintext text-muted" name="adminID" id="adminName" value="nuhadmin-001" style="font-weight: 600; max-width: 10rem;">
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="Adminpassword" class="form-control-plaintext">
                                </div>
                            </div>
