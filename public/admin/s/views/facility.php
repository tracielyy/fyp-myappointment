                    ...
                    <div class="card text-dark innerCard mb-3">
                        <div class="card-title ms-2 mt-2">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-start" style=" margin-top: 10px;">
                                <input type="text" readonly class="form-control-plaintext text-muted" name="adminName" value="Admin-nuh" style="font-weight: 600;">
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" readonly class="form-control-plaintext" id="staticAddress" value="5 Lower Kent Ridge Rd, Singapore 119074">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="contact" class="col-sm-2 col-form-label">Contact: </label>
                                <div class="col-sm-10">
                                  <input type="text" readonly class="form-control-plaintext" id="staticContact" value="67795555">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="openinghour" class="col-sm-2 col-form-label">Opening Hour: </label>
                                <div class="col-sm-10">
                                  <input type="text" placeholder="09-00" onfocus="(this.type='time')" style="margin-top: 5px; border: 1px solid #eeeded; background-color: #eeeded;">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="closinghour" class="col-sm-2 col-form-label">Closing Hour: </label>
                                <div class="col-sm-10">
                                    <input type="text" placeholder="23-00" onfocus="(this.type='time')" style="margin-top: 5px; border: 1px solid #eeeded; background-color: #eeeded;">
                                </div>
                            </div>
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end" style=" margin-top: 10px;">
                                <a href="editMF.html" class="btn btn-success me-md-2 mr-2">
                                    <span><i class="fas fa-pen-square"></i></span>
                                    <span>Edit</span>
                                </a>
                                <a href="SuperAdminhomepage.html" class="btn btn-danger" id="delBtn">
