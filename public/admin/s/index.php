                                ...
                                <div class="card text-dark innerCard mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" readonly class="form-control-plaintext" id="staticAddress" value="<?php echo $facility->get_address(); ?>">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="contact" class="col-sm-2 col-form-label">Contact: </label>
                                            <div class="col-sm-10">
                                                <input type="text" readonly class="form-control-plaintext" id="staticContact" value="<?php echo $facility->get_contactnumber(); ?>">
                                            </div>
                                        </div>
