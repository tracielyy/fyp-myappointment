    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarAppt">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link <?php if ($pageName == 'homepage') {echo 'active';} ?>" aria-current="page" href="./homepage.php">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./login.php">Create an Appointment</a>
          </li>
          <li class="nav-item">
          <a class="nav-link" href="./login.php">View Appointment</a>
          </li>
        </ul>
        <div class="row mx-3">
        <div class="col-8"> 
